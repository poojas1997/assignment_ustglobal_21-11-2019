...
////			List<EmployeeBean> result2 = dao2.deleteEmployeeData(int id);
			break;
		...
		case 4:
			...
			dao3.deleteEmployeeData(id);
			int count = dao3.deleteEmployeeData(id);
		...
		case 5:
			...
			dao5.searchEmployeeData(id1);
			EmployeeBean bean = dao5.searchEmployeeData(id1);
			if(bean!=null) {
